...
public getUserstoriesBySprintBacklog(idSprintBacklog:number,idProjet:number):Observable<Userstory[]>{
  return this.http.get<Userstory[]>('http://localhost:8070/userStorys/'+idSprintBacklog+'/'+idProjet);
}
}